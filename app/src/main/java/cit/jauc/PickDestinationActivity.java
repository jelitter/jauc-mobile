...
import cit.jauc.model.PulseMarkerViewOptions;
...
public class PickDestinationActivity extends AppCompatActivity {
    ...
    private Button clearDisplayViewButton;
            ...
            public void onCameraChange(CameraPosition position) {
                ...
                if (view != null) {
                    ...
                    if (pulseAnimation == null && distance < 0.5f * circleDiameterSize) {
                        pulseAnimation = AnimationUtils.loadAnimation(PickDestinationActivity.this, R.anim.pulse);
    ...
    private void createClearSelectionButton() {
        clearDisplayViewButton = (Button) findViewById(R.id.bt_clearDisplayView);
    ...
    private void createSelectLocationButton() {
        Button selectLocationButton = (Button) findViewById(R.id.bt_selectLocation);
